...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/geometria

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/geometria: ${OBJECTFILES}
...
${OBJECTDIR}/SegmentAgg.o: SegmentAgg.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SegmentAgg.o SegmentAgg.cpp

${OBJECTDIR}/SegmentComp.o: SegmentComp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SegmentComp.o SegmentComp.cpp
